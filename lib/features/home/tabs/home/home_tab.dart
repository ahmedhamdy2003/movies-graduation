...
import '../../presentation/movie_details_screen/movie_details_screen.dart';
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: Row(
                            mainAxisSize: MainAxisSize.min,
                            children: [
                              const Text("See More", style: TextStyle(color: ColorsManager.yellow)),
                              const SizedBox(width: 5),
                              const Icon(Icons.arrow_forward, color: ColorsManager.yellow),
                            ],
                          ),
                        ),
                      ],
